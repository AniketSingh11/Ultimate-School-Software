...
class Certificate_template extends Admin_Controller {
    ...
    protected function rules() {
        $rules = array(
            ...
            array(
                ...
                'label' => $this->lang->line("certificate_template_backgroubd_image"),
    ...
    //             // dd($this->data['certificate_template']);

    //             $this->data['template_convert'] = $this->studentTagHiglightForTemplate($this->data['certificate_template']->template);

    //             $this->data["subview"] = "certificate_template/print_preview";
    //             $this->load->view('_layout_main', $this->data);
    //             $this->printView($this->data, 'certificate_template/print_preview');
    //         } else {
    //             $this->data["subview"] = "error";
    //             $this->load->view('_layout_main', $this->data);
    //         }
    ...
    //             $this->viewsendtomail($this->data['certificate_template'], '/certificate_template/print_preview', $email, $subject, $message);
    //         } else {
    //             $this->data["subview"] = "error";
    //             $this->load->view('_layout_main', $this->data);
    //         }
