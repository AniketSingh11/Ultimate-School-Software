    ...
    protected function rules() {
        $rules = array(
            ...
            array(
                ...
                'label' => $this->lang->line("asset_assignment_quantity"),
                'rules' => 'trim|xss_clean|max_length[128]|callback_valid_quantity'
            ),
            array(
                'field' => 'usertypeID',
            ...
            array(
                'field'  => 'check_out_to',
                'label'  => $this->lang->line("check_out_to"),
                'rules'  => 'trim|xss_clean|max_length[128]'
            ),
            array(
                'field' => 'due_date',
                'label' => $this->lang->line("due_date"),
                'rules' => 'trim|xss_clean|max_length[128]|callback_date_valid'
            ),
            array(
                'field' => 'check_out_date',
                'label' => $this->lang->line("check_out_date"),
                'rules' => 'trim|xss_clean|max_length[128]|callback_date_valid'
            ),
            array(
                'field' => 'check_in_date',
                'label' => $this->lang->line("check_in_date"),
                'rules' => 'trim|xss_clean|max_length[128]|callback_date_valid'
            ),
            array(
        ...
        if((int)$id) {
            ...
            if($this->data['asset_assignment']) {
                ...
                if($usertypeID == 3) {
                    ...
                    if(count($student)) {
                        $this->data['user'] = $this->allUsersArray($usertypeID, $student->classesID);
                    } else {
                        $this->data['user'] = array();
                    }
                } else {
                    $this->data['user'] = $this->allUsersArray($usertypeID);
                }
