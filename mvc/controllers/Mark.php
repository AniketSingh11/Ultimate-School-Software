	...
	public function add() {
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $students = $this->student_m->get_order_by_student(array(
					"classesID" => $classesID,
					'schoolyearID' => $schoolyearID,
					'studentextend.optionalsubjectID' => $subject->subjectID
				));
                ...
                if($optional) {
                    $whereArray['studentextend.optionalsubjectID'] = $subject->subjectID;
                }

				$students = $this->student_m->get_order_by_student($whereArray);
