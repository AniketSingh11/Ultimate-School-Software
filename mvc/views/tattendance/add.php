                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-2"><?=btn_attendance('', '', 'all_attendance', $this->lang->line('add_all_attendance')).$this->lang->line('tattendance_presentandabsent')?></th>
                                    <th class="col-sm-2"><?=btn_attendance('', '', 'all_attendance_late', $this->lang->line('add_all_attendance')).$this->lang->line('tattendance_late')?></th>
                                </tr>
                            </thead>
                            <tbody id="list">
                                <?php if(count($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                                    <tr>
                                        ...
                                        <td data-title="<?=$this->lang->line('tattendance_presentandabsent')?>">
                                            <?php
                                                $aday = "a".abs($day);
                                                foreach ($tattendances as $tattendance) {
                                                    if($monthyear == $tattendance->monthyear && $tattendance->teacherID == $teacher->teacherID) {
                                                        ...
                                                        echo  btn_attendance($tattendance->tattendanceID, $method, "attendance btn btn-warning attendance-$tattendance->tattendanceID", $this->lang->line('add_title'));
                                                        break;
                                                    }
                                        ...
                                        <td data-title="<?=$this->lang->line('tattendance_late')?>">
                                            <?php
                                                $aday = "a".abs($day);
                                                foreach ($tattendances as $tattendance) {
                                                    if ($monthyear == $tattendance->monthyear && $tattendance->teacherID == $teacher->teacherID) {
                                                        $method = '';
                                                        if($tattendance->$aday == "L") {$method = "checked";}
                                                        echo  btn_attendance($tattendance->tattendanceID, $method, "attendance_late btn btn-warning attendance_late-$tattendance->tattendanceID", $this->lang->line('add_title'));
                                                        break;
                                                    }
                                                }
                                            ?>
