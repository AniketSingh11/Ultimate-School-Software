        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        if(form_error('frontendorbackend'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="frontendorbackend" class="col-sm-2 control-label">
                            <?=$this->lang->line("setting_school_frontend")?>
                        ...
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('frontendorbackend'); ?>
                        </span>
                    </div>
