    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("attendance_studentgroup")?></th>
              <td width="60%"><?=isset($studentgroups[$student->studentgroupID]) ? $studentgroups[$student->studentgroupID] : '' ?></td>
          </tr>

          <tr>
              <th width="40%"><?=$this->lang->line("attendance_optionalsubject")?></th>
              <td width="60%"><?=isset($optionalSubjects[$student->optionalsubjectID]) ? $optionalSubjects[$student->optionalsubjectID] : '' ?></td>
          </tr>
          ...
          <tr>
           ...
           <tr>
              <th width="40%"><?=$this->lang->line("attendance_extracurricularactivities")?></th>
              <td width="60%"><?php  echo $student->extracurricularactivities; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("attendance_remarks")?></th>
              <td width="60%"><?php  echo $student->remarks; ?></td>
          </tr>
        </tbody>
      </table>
