                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=btn_attendance('', '', 'all_attendance', $this->lang->line('add_all_attendance')).$this->lang->line('attendance_presentandabsent')?></th>
                                <th class="col-sm-2"><?=btn_attendance('', '', 'all_attendance_late', $this->lang->line('add_all_attendance_late')).$this->lang->line('attendance_late')?></th>
                            </tr>
                        </thead>
                        <tbody id="list">
                            <?php if(count($students)) {$i = 1; foreach($students as $student) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('attendance_presentandabsent')?>">
                                        <?php
                                            $aday = "a".abs($day);
                                            ...
                                            foreach ($attendances as $attendance) {
                                                if($setting->attendance=="subject") {
                                                    if($monthyear == $attendance->monthyear && $attendance->studentID == $student->studentID && $attendance->classesID == $student->classesID && $attendance->subjectID == $sID) {
                                                        ...
                                                        echo  btn_attendance($attendance->attendanceID, $method, "attendance btn btn-warning attendance-$attendance->attendanceID", $this->lang->line('add_title'));
                                                        break;
                                                    }
                                                } else {
                                    ...
                                    <td data-title="<?=$this->lang->line('attendance_late')?>">
                                        <?php
                                            $aday = "a".abs($day);
                                            ...
                                            foreach ($attendances as $attendance) {
                                                if($setting->attendance=="subject") {
                                                    if($monthyear == $attendance->monthyear && $attendance->studentID == $student->studentID && $attendance->classesID == $student->classesID && $attendance->subjectID == $sID) {
                                                        $method = '';
                                                        if($attendance->$aday == "L") {$method = "checked";}
                                                        echo  btn_attendance($attendance->attendanceID, $method, "attendance_late btn btn-warning attendance_late-$attendance->attendanceID", $this->lang->line('add_title'));
                                                        break;
                                                    }
                                                } else {
                    ...
                    $('.all_attendance').click(function() {
                        ...
                        if(parseInt(classes) && parseInt(day)) {
                            $.ajax({
                                ...
                                data: {"day" : day, "classes" : classes, "section" : section, "subject" : subjectID , "monthyear" : monthyear , "method" : 'presentandabsent' , "status" : status },
                                dataType: "html",
                                success: function(data) {
                    ...
                    $('.all_attendance_late').click(function() {
                        ...
                        if(parseInt(classes) && parseInt(day)) {
                            $.ajax({
                                type: 'POST',
                                url: "<?=base_url('sattendance/all_add')?>",
                                data: {"day" : day, "classes" : classes, "section" : section, "subject" : subjectID , "monthyear" : monthyear , "method" : 'late' , "status" : status },
                                dataType: "html",
                                success: function(data) {
