    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
          <tbody>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("hmember_studentgroup")?></th>
                <td width="60%"><?=isset($studentgroups[$student->studentgroupID]) ? $studentgroups[$student->studentgroupID] : '' ?></td>
            </tr>

            <tr>
                <th width="40%"><?=$this->lang->line("hmember_optionalsubject")?></th>
            ...
            <tr>
             ...
             <tr>
                 <th width="40%"><?=$this->lang->line("hmember_extracurricularactivities")?></th>
                 <td width="60%"><?php  echo $student->extracurricularactivities; ?></td>
             </tr>
             <tr>
                 <th width="40%"><?=$this->lang->line("hmember_remarks")?></th>
